...
namespace TestScriptCommon
{
	public class ProblemData
	{
		...
		public void AddProblem(string id, string groupId, string tags, bool isChallenge)
		{
			pd.Add(id, new ProblemRec(id, groupId, tags, isChallenge));
		}
		...
		public class ProblemRec
		{
			...
			public ProblemRec(string id, string groupId, string tags, bool isChallenge)
			{
				this.id = id;
