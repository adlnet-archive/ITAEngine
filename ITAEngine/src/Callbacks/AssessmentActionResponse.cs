...
namespace ITAEngine
{
	public interface AssessmentActionResponse
	{
		/// <summary>The student has fail a specific skill, the assessment 'can' be terminated.</summary>
		/// <param name="skillid">The id of the skill</param>
		/// <param name="timeThreshold">Indicates that a problem was below timeing threshold</param>
		void TerminateAssessment(string skillid, bool belowTimeThreshold);
		
		/// <summary>All questions have been asked and the assessment is over.</summary>
